    ...
    if User.get() == "":
        ...
        try:
            ...
            if row == None:
                ...
                title = Label(frame1, text="Forgot Password", font=("times", 22, "bold"), bg='white', fg="red").place(
                    x=0, y=0, relwidth=1)

                secquel2 = Label(frame1, text="Security Question", font=('arial', 15, 'bold'), fg='black').place(x=85,
                                                                                                                 y=70)
                forgot_password_window.secQue2 = ttk.Combobox(frame1, font=('caliber', 13), width=22)
                forgot_password_window.secQue2['values'] = (
                    '', 'Your first pet name', 'Your birth place', 'Your best friend name', 'Your First School Name')
                forgot_password_window.secQue2.place(x=85, y=100)

                secansl2 = Label(frame1, text="Security Answer", font=('arial', 15, 'bold'), fg='black').place(x=85,
                                                                                                               y=150)
                forgot_password_window.secAns2 = Entry(frame1, width=20, font=('caliber', 15),
                                                       highlightbackground='black',
                                                       highlightthickness=1, bg='lightgray')
                forgot_password_window.secAns2.place(x=85, y=180)

                newPasswordl = Label(frame1, text="New Password", font=('arial', 15, 'bold'), fg='black').place(x=85,
                                                                                                                y=230)
                forgot_password_window.newPassword = Entry(frame1, width=20, font=('caliber', 15),
                                                           highlightbackground='black',
                                                           highlightthickness=1, bg='lightgray', show="*")
                forgot_password_window.newPassword.place(x=85, y=260)

                cnfnewPasswordl = Label(frame1, text="Confirm New Password", font=('arial', 15, 'bold'),
                                        fg='black').place(x=85, y=310)
                forgot_password_window.cnfnewPassword = Entry(frame1, width=20, font=('caliber', 15),
                                                              highlightbackground='black',
                                                              highlightthickness=1, bg='lightgray', show="*")
                forgot_password_window.cnfnewPassword.place(x=85, y=340)

                chng_btn = Button(frame1, text="RESET PASSWORD", bg='green', fg='white',bd=5, font=('times', 15, 'bold'),
                                  command=forgot_password).place(x=98, y=415)
            ...
            if row != None:
                ...
                cur.execute(sqlinsert,
                            (newLogin.first_name.get(), newLogin.last_name.get(), newLogin.EmailID.get(),
                             ...
                             newLogin.mobnum.get(), newLogin.set_password.get(), newLogin.secQue.get(),
                             newLogin.secAns.get()))
                connection.commit()
                connection.close()
...
def data_barChart2():
    ...
    if monthTracker.opt_box.get() == "Bar Graph":
        ...
        plt.plot(mnth1, amnt1, 'ro-',alpha=0.9, label="Debit")
        plt.plot(mnth1, amnt2, 'bo-',alpha=0.9, label="Credit")
        plt.xlabel("Month's")
        plt.ylabel("Amount")
        plt.title("Amount V/S Month")
        plt.legend(loc="best", shadow=True, fontsize="medium")
...
def newWindow():
    ...
    scrlbar1.place(relx=0.98, rely=0.94, relheight=0.808, anchor='se')
    ...
    scrlbar2.place(relx=0.98, rely=0.11, relheight=0.864, anchor='ne')
...
def newLogin():
    ...
    newlogin.geometry("1500x760+5+13")
    ...
    something_1 = Label(frame1, text="USER DETAILS", font=('times', 34, 'bold'), bg="white", fg="#08a3d2")
    something_1.place(x=390, y=90)
    ...
    Email = Label(frame1, text="Email-ID/Username", font=('arial', 18, 'bold'), bg='white', fg='black').place(x=650,
                                                                                                              y=200)
    ...
    mobnum = Label(frame1, text="Mobile Number", font=('arial', 18, 'bold'), bg='white', fg='black').place(x=540,
                                                                                                           y=280)
    ...
    secquel = Label(frame1, text="Security Question", font=('arial', 18, 'bold'), bg='white', fg='black').place(
        x=200, y=360)
    newLogin.secQue = ttk.Combobox(frame1, font=('caliber', 17), width=19)
    newLogin.secQue['values'] = (
        '', 'Your first pet name', 'Your birth place', 'Your best friend name', 'Your First School Name')
    newLogin.secQue.place(x=200, y=390)

    secansl = Label(frame1, text="Security Answer", font=('arial', 18, 'bold'), bg='white', fg='black').place(x=540,
                                                                                                              y=360)
    newLogin.secAns = Entry(frame1, width=20, font=('caliber', 17), highlightbackground='black',
                            highlightthickness=1, bg='lightgray')
    newLogin.secAns.place(x=540, y=390)

    set_pass = Label(frame1, text="Set Password", font=('arial', 18, 'bold'), bg='white', fg='black').place(x=200,
                                                                                                            y=440)
    ...
    cnf_password = Label(frame1, text="Confirm Password", font=('arial', 18, 'bold'), bg='white', fg='black').place(
        x=540, y=440)
    ...
    save.place(x=440, y=530)

    image9 = Image.open("back.jfif")
    image9 = image9.resize((80, 50), Image.ANTIALIAS)
    test9 = ImageTk.PhotoImage(image9)
    label9 = Label(newlogin, image=test9)
    label9.image = test9

    back_btn = Button(newlogin, width=50, height=20, bg='gray', command=back, compound=LEFT, relief=FLAT, bd=5,
                      image=test9, cursor="hand2")
    back_btn.place(x=1400, y=20)
...
forget = Button(root, text="Forgot Password? ", font=('times', 16, 'italic'), bg='#8c816f', fg='#ee0000', cursor="hand2",
